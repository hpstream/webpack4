    ...
    downloadAmrBlob: function(amr_url, download_success_cb, download_progress_cb) {
        ...
        xhr.onreadystatechange = function(e) {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                self.amrType = xhr.response.type;
                self.canPlay = true;
...
amrEvent.prototype = {
    ...
    initDownloadBtnClickEvent: function(amrEle, selectBtn) { // init download button click event
        ...
        if (downloadBtn != undefined) {
            ...
            console.log("not the download button, download img button must has ( name='downloadBtn' ) this property");
        }
    },
    ...
    autoplay: function(self, amrEle) { // amr player autoplay
        ...
        if (playBtn.length > 0) {
            ...
            console.log("don't have the play button, play img button must has ( name='playBtn' ) this property");
        }
    },
